...
namespace oadr2b
{
  ...
  {
    ::std::ostream&
    operator<< (::std::ostream& o, ReadingTypeEnumeratedType::value i)
    {
      return o << ReadingTypeEnumeratedType::_xsd_ReadingTypeEnumeratedType_literals_[i];
    }

    ::std::ostream&
    operator<< (::std::ostream& o, const ReadingTypeEnumeratedType& i)
    {
