...
namespace oadr2b
{
  namespace ei
  {
    ...
    eiActivePeriodType::
    eiActivePeriodType (::std::auto_ptr< properties_type > properties,
                        const components_type& components)
    : ::xml_schema::type (),
      properties_ (properties, this),
      components_ (components, this)
    ...
    eiActivePeriodType::
    eiActivePeriodType (::std::auto_ptr< properties_type > properties,
                        ::std::auto_ptr< components_type > components)
    : ::xml_schema::type (),
      properties_ (properties, this),
      components_ (components, this)
    {
        ...
        //
        {
          ::std::auto_ptr< ::xsd::cxx::tree::type > tmp (
            ::xsd::cxx::tree::type_factory_map_instance< 0, char > ().create (
              ...
              &::xsd::cxx::tree::factory_impl< components_type >,
          ...
          if (tmp.get () != 0)
          {
            if (!components_.present ())
            {
              ::std::auto_ptr< components_type > r (
                dynamic_cast< components_type* > (tmp.get ()));
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, eiActivePeriodType >
    _xsd_eiActivePeriodType_type_factory_init (
      "eiActivePeriodType",
  ...
  namespace ei
  {
    ...
    operator<< (::xercesc::DOMElement& e, const eiActivePeriodType& i)
    {
      ...
      //
      {
        ...
        const eiActivePeriodType::components_type& x (i.components ());
        if (typeid (eiActivePeriodType::components_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "components",
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, eiActivePeriodType >
    _xsd_eiActivePeriodType_type_serializer_init (
      "eiActivePeriodType",
      "http://docs.oasis-open.org/ns/energyinterop/201110");
  }
}
