...
namespace oadr2b
{
  namespace ei
  {
    class eiEventSignalType: public ::xml_schema::type
    {
      ...
      void
      intervals (::std::auto_ptr< intervals_type > p);
      ...
      void
      signalName (::std::auto_ptr< signalName_type > p);
      ...
      void
      signalType (::std::auto_ptr< signalType_type > p);
      ...
      void
      currentValue (::std::auto_ptr< currentValue_type > p);
      ...
      eiEventSignalType (::std::auto_ptr< intervals_type >,
                         const signalName_type&,
                         const signalType_type&,
                         const signalID_type&);

      eiEventSignalType (::std::auto_ptr< intervals_type >,
                         ::std::auto_ptr< signalName_type >,
                         ::std::auto_ptr< signalType_type >,
                         ::std::auto_ptr< signalID_type >);
