...
namespace oadr2b
{
  namespace oadr
  {
    ...
    CurrentType::
    CurrentType (::std::auto_ptr< itemDescription_type > itemDescription,
  ...
  namespace oadr
  {
    ...
    operator<< (::xercesc::DOMElement& e, const CurrentType& i)
    {
      ...
      //
      {
        ...
        const CurrentType::itemDescription_type& x (i.itemDescription ());
        if (typeid (CurrentType::itemDescription_type) == typeid (x))
        {
      ...
      //
      {
        ...
        const CurrentType::itemUnits_type& x (i.itemUnits ());
        if (typeid (CurrentType::itemUnits_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "itemUnits",
      ...
      //
      {
        ...
        const CurrentType::siScaleCode_type& x (i.siScaleCode ());
        if (typeid (CurrentType::siScaleCode_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "siScaleCode",
