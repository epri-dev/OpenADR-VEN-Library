...
namespace icalendar_2_0
{
  class properties: public ::xml_schema::type
  {
    ...
    void
    x_eiNotification (::std::auto_ptr< x_eiNotification_type > p);
    ...
    void
    x_eiRampUp (::std::auto_ptr< x_eiRampUp_type > p);
    ...
    void
    x_eiRecovery (::std::auto_ptr< x_eiRecovery_type > p);
    ...
    properties (::std::auto_ptr< dtstart_type >,
