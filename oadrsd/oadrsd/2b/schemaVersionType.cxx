...
namespace oadr2b
{
  namespace ei
  {
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, schemaVersionType >
    _xsd_schemaVersionType_type_factory_init (
      "schemaVersionType",
...
namespace oadr2b
{
  namespace ei
  {
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, schemaVersionType >
    _xsd_schemaVersionType_type_serializer_init (
      "schemaVersionType",
      "http://docs.oasis-open.org/ns/energyinterop/201110");
  }
}
