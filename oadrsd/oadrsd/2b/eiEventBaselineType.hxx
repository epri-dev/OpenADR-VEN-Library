...
namespace oadr2b
{
  namespace ei
  {
    class eiEventBaselineType: public ::xml_schema::type
    {
      ...
      void
      baselineID (::std::auto_ptr< baselineID_type > p);
      ...
      void
      baselineName (::std::auto_ptr< baselineName_type > p);
      ...
      eiEventBaselineType (::std::auto_ptr< dtstart_type >,
                           ::std::auto_ptr< duration_type >,
                           ::std::auto_ptr< intervals_type >,
                           const baselineID_type&,
                           const baselineName_type&);
      ...
      eiEventBaselineType (::std::auto_ptr< dtstart_type >,
                           ::std::auto_ptr< duration_type >,
                           ::std::auto_ptr< intervals_type >,
                           ::std::auto_ptr< baselineID_type >,
                           ::std::auto_ptr< baselineName_type >);
