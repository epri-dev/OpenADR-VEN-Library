...
namespace oadr2b
{
  namespace oadr
  {
    class oadrCreatedEventType: public ::xml_schema::type
    {
      public:
      // eiCreatedEvent
      // 
      ...
      void
      eiCreatedEvent (::std::auto_ptr< eiCreatedEvent_type > p);
      ...
      oadrCreatedEventType (::std::auto_ptr< eiCreatedEvent_type >);
