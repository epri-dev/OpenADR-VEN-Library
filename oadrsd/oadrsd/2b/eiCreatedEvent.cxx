...
namespace payloads
{
  ...
  void eiCreatedEvent::
  eventResponses (::std::auto_ptr< eventResponses_type > x)
  {
    this->eventResponses_.set (x);
  }
...
namespace payloads
{
  ...
  eiCreatedEvent::
  eiCreatedEvent (::std::auto_ptr< eiResponse_type > eiResponse,
                  const venID_type& venID)
  : ::xml_schema::type (),
    eiResponse_ (eiResponse, this),
    eventResponses_ (this),
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      {
        ::std::auto_ptr< eventResponses_type > r (
          eventResponses_traits::create (i, f, this));

        if (!this->eventResponses_)
        {
          this->eventResponses_.set (r);
          continue;
        }
      }
...
namespace payloads
{
  ...
  operator<< (::xercesc::DOMElement& e, const eiCreatedEvent& i)
  {
    ...
    //
    {
      ...
      const eiCreatedEvent::eiResponse_type& x (i.eiResponse ());
      if (typeid (eiCreatedEvent::eiResponse_type) == typeid (x))
      {
    ...
    //
    {
      ...
      const eiCreatedEvent::venID_type& x (i.venID ());
      if (typeid (eiCreatedEvent::venID_type) == typeid (x))
      {
        ::xercesc::DOMElement& s (
          ::xsd::cxx::xml::dom::create_element (
            "venID",
