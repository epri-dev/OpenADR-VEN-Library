...
namespace oadr2b
{
  ...
  {
    ::std::ostream&
    operator<< (::std::ostream& o, const signalPayloadType& i)
    {
    ...
    static
    const ::xsd::cxx::tree::std_ostream_initializer< 0, char, signalPayloadType >
    _xsd_signalPayloadType_std_ostream_init;
  }
}
