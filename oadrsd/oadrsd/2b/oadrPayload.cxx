...
namespace oadr2b
{
  namespace oadr
  {
    ...
    void oadrPayload::
    oadrSignedObject (::std::auto_ptr< oadrSignedObject_type > x)
    {
      this->oadrSignedObject_.set (x);
    }
  }
...
namespace oadr2b
{
  namespace oadr
  {
    ...
    oadrPayload::
    oadrPayload (::std::auto_ptr< oadrSignedObject_type > oadrSignedObject)
    : ::xml_schema::type (),
      Signature_ (this),
      oadrSignedObject_ (oadrSignedObject, this)
    {
  ...
  namespace oadr
  {
    ...
    operator<< (::xercesc::DOMElement& e, const oadrPayload& i)
    {
      ...
      //
      {
        ...
        if (i.Signature ())
        {
          const oadrPayload::Signature_type& x (*i.Signature ());
          if (typeid (oadrPayload::Signature_type) == typeid (x))
          {
