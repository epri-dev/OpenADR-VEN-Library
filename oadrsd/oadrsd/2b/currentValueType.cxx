...
namespace oadr2b
{
  namespace ei
  {
    ...
    void currentValueType::
    payloadFloat (::std::auto_ptr< payloadFloat_type > x)
    {
      this->payloadFloat_.set (x);
    }
  }
...
namespace oadr2b
{
  namespace ei
  {
    ...
    currentValueType::
    currentValueType (::std::auto_ptr< payloadFloat_type > payloadFloat)
    : ::xml_schema::type (),
      payloadFloat_ (payloadFloat, this)
    {
    }
      ...
      for (; p.more_elements (); p.next_element ())
      {
        ...
        //
        {
          ...
          if (tmp.get () != 0)
          {
            ...
            {
              ::std::auto_ptr< payloadFloat_type > r (
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, currentValueType >
    _xsd_currentValueType_type_factory_init (
      "currentValueType",
      "http://docs.oasis-open.org/ns/energyinterop/201110");
  }
}
...
namespace oadr2b
{
  namespace ei
  {
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, currentValueType >
    _xsd_currentValueType_type_serializer_init (
      "currentValueType",
      "http://docs.oasis-open.org/ns/energyinterop/201110");
  }
}
