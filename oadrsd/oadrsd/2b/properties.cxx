...
namespace icalendar_2_0
{
  ...
  void properties::
  x_eiNotification (::std::auto_ptr< x_eiNotification_type > x)
  {
    this->x_eiNotification_.set (x);
  }
  ...
  void properties::
  x_eiRampUp (::std::auto_ptr< x_eiRampUp_type > x)
  {
    this->x_eiRampUp_.set (x);
  }
  ...
  void properties::
  x_eiRecovery (::std::auto_ptr< x_eiRecovery_type > x)
  {
    this->x_eiRecovery_.set (x);
  }
}
...
namespace icalendar_2_0
{
  ...
  properties::
  properties (::std::auto_ptr< dtstart_type > dtstart,
      ...
      //
      {
        ::std::auto_ptr< ::xsd::cxx::tree::type > tmp (
          ::xsd::cxx::tree::type_factory_map_instance< 0, char > ().create (
            ...
            &::xsd::cxx::tree::factory_impl< x_eiNotification_type >,
            true, true, i, n, f, this));
        ...
        if (tmp.get () != 0)
        {
          ...
          {
            ::std::auto_ptr< x_eiNotification_type > r (
              dynamic_cast< x_eiNotification_type* > (tmp.get ()));
      ...
      //
      {
        ::std::auto_ptr< ::xsd::cxx::tree::type > tmp (
          ::xsd::cxx::tree::type_factory_map_instance< 0, char > ().create (
            "x-eiRampUp",
            "http://docs.oasis-open.org/ns/energyinterop/201110",
            &::xsd::cxx::tree::factory_impl< x_eiRampUp_type >,
            true, true, i, n, f, this));
        ...
        if (tmp.get () != 0)
        {
          if (!this->x_eiRampUp_)
          {
            ::std::auto_ptr< x_eiRampUp_type > r (
              dynamic_cast< x_eiRampUp_type* > (tmp.get ()));
      ...
      //
      {
        ::std::auto_ptr< ::xsd::cxx::tree::type > tmp (
          ::xsd::cxx::tree::type_factory_map_instance< 0, char > ().create (
            "x-eiRecovery",
            "http://docs.oasis-open.org/ns/energyinterop/201110",
            &::xsd::cxx::tree::factory_impl< x_eiRecovery_type >,
            true, true, i, n, f, this));
        ...
        if (tmp.get () != 0)
        {
          ...
          {
            ::std::auto_ptr< x_eiRecovery_type > r (
              dynamic_cast< x_eiRecovery_type* > (tmp.get ()));
...
namespace icalendar_2_0
{
  ...
  operator<< (::xercesc::DOMElement& e, const properties& i)
  {
    ...
    //
    {
      ...
      const properties::duration_type& x (i.duration ());
      if (typeid (properties::duration_type) == typeid (x))
      {
        ::xercesc::DOMElement& s (
          ::xsd::cxx::xml::dom::create_element (
            "duration",
    ...
    //
    {
      ...
      {
        const properties::x_eiNotification_type& x (*i.x_eiNotification ());
        if (typeid (properties::x_eiNotification_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "x-eiNotification",
    ...
    //
    {
      ...
      if (i.x_eiRampUp ())
      {
        ...
        if (typeid (properties::x_eiRampUp_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "x-eiRampUp",
    ...
    //
    {
      ...
      if (i.x_eiRecovery ())
      {
        const properties::x_eiRecovery_type& x (*i.x_eiRecovery ());
        if (typeid (properties::x_eiRecovery_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "x-eiRecovery",
