...
namespace oadr2b
{
  namespace oadr
  {
    class oadrCreatePartyRegistrationType: public ::xml_schema::type
    {
      ...
      void
      requestID (::std::auto_ptr< requestID_type > p);
      ...
      void
      oadrProfileName (::std::auto_ptr< oadrProfileName_type > p);
      ...
      void
      oadrTransportName (::std::auto_ptr< oadrTransportName_type > p);
      ...
      void
      oadrTransportAddress (::std::auto_ptr< oadrTransportAddress_type > p);
      ...
      void
      oadrVenName (::std::auto_ptr< oadrVenName_type > p);
      ...
      oadrCreatePartyRegistrationType (::std::auto_ptr< requestID_type >,
                                       ::std::auto_ptr< oadrProfileName_type >,
                                       ::std::auto_ptr< oadrTransportName_type >,
                                       const oadrReportOnly_type&,
                                       const oadrXmlSignature_type&);
