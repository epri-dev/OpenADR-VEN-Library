...
namespace oadr2b
{
  namespace oadr
  {
    ...
    void oadrReportType::
    eiReportID (::std::auto_ptr< eiReportID_type > x)
    {
      this->eiReportID_.set (x);
    }
    ...
    void oadrReportType::
    reportName (::std::auto_ptr< reportName_type > x)
    {
      this->reportName_.set (x);
    }
...
namespace oadr2b
{
  namespace oadr
  {
    ...
    oadrReportType::
    oadrReportType (::std::auto_ptr< reportRequestID_type > reportRequestID,
                    ::std::auto_ptr< reportSpecifierID_type > reportSpecifierID,
        ...
        //
        {
          ::std::auto_ptr< ::xsd::cxx::tree::type > tmp (
            ::xsd::cxx::tree::type_factory_map_instance< 0, char > ().create (
              ...
              &::xsd::cxx::tree::factory_impl< eiReportID_type >,
          ...
          if (tmp.get () != 0)
          {
            if (!this->eiReportID_)
            {
              ::std::auto_ptr< eiReportID_type > r (
                dynamic_cast< eiReportID_type* > (tmp.get ()));
        ...
        //
        {
          ::std::auto_ptr< ::xsd::cxx::tree::type > tmp (
            ::xsd::cxx::tree::type_factory_map_instance< 0, char > ().create (
              ...
              &::xsd::cxx::tree::factory_impl< oadrReportDescription_type >,
              true, true, i, n, f, this));

          if (tmp.get () != 0)
          {
            ::std::auto_ptr< oadrReportDescription_type > r (
              dynamic_cast< oadrReportDescription_type* > (tmp.get ()));
            ...
            this->oadrReportDescription_.push_back (r);
            continue;
          }
        }
        ...
        //
        {
          ::std::auto_ptr< ::xsd::cxx::tree::type > tmp (
            ::xsd::cxx::tree::type_factory_map_instance< 0, char > ().create (
              "reportName",
              "http://docs.oasis-open.org/ns/energyinterop/201110",
              &::xsd::cxx::tree::factory_impl< reportName_type >,
              true, true, i, n, f, this));
          ...
          if (tmp.get () != 0)
          {
            if (!this->reportName_)
            {
              ::std::auto_ptr< reportName_type > r (
                dynamic_cast< reportName_type* > (tmp.get ()));
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, oadrReportType >
    _xsd_oadrReportType_type_factory_init (
      "oadrReportType",
      "http://openadr.org/oadr-2.0b/2012/07");
  }
}
  ...
  namespace oadr
  {
    ...
    operator<< (::xercesc::DOMElement& e, const oadrReportType& i)
    {
      ...
      //
      {
        ...
        if (i.eiReportID ())
        {
          const oadrReportType::eiReportID_type& x (*i.eiReportID ());
          if (typeid (oadrReportType::eiReportID_type) == typeid (x))
          {
      ...
      //
      {
        ...
        for (oadrReportType::oadrReportDescription_const_iterator
             ...
             b != n; ++b)
        {
          if (typeid (oadrReportType::oadrReportDescription_type) == typeid (*b))
          {
            ::xercesc::DOMElement& s (
              ::xsd::cxx::xml::dom::create_element (
                "oadrReportDescription",
      ...
      //
      {
        ...
        const oadrReportType::reportRequestID_type& x (i.reportRequestID ());
        if (typeid (oadrReportType::reportRequestID_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "reportRequestID",
      ...
      //
      {
        ...
        const oadrReportType::reportSpecifierID_type& x (i.reportSpecifierID ());
        if (typeid (oadrReportType::reportSpecifierID_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "reportSpecifierID",
      ...
      //
      {
        ...
        if (i.reportName ())
        {
          const oadrReportType::reportName_type& x (*i.reportName ());
          if (typeid (oadrReportType::reportName_type) == typeid (x))
          {
            ::xercesc::DOMElement& s (
              ::xsd::cxx::xml::dom::create_element (
                "reportName",
      ...
      //
      {
        ...
        const oadrReportType::createdDateTime_type& x (i.createdDateTime ());
        if (typeid (oadrReportType::createdDateTime_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "createdDateTime",
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, oadrReportType >
    _xsd_oadrReportType_type_serializer_init (
      "oadrReportType",
      "http://openadr.org/oadr-2.0b/2012/07");
  }
}
