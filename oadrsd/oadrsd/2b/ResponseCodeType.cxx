...
namespace oadr2b
{
  namespace ei
  {
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, ResponseCodeType >
    _xsd_ResponseCodeType_type_factory_init (
      "ResponseCodeType",
...
namespace oadr2b
{
  namespace ei
  {
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, ResponseCodeType >
    _xsd_ResponseCodeType_type_serializer_init (
      "ResponseCodeType",
      "http://docs.oasis-open.org/ns/energyinterop/201110");
  }
}
