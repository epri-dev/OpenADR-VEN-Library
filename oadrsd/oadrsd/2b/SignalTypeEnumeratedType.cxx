...
namespace oadr2b
{
  ...
  {
    ::std::ostream&
    operator<< (::std::ostream& o, SignalTypeEnumeratedType::value i)
    {
      return o << SignalTypeEnumeratedType::_xsd_SignalTypeEnumeratedType_literals_[i];
    }

    ::std::ostream&
    operator<< (::std::ostream& o, const SignalTypeEnumeratedType& i)
    {
