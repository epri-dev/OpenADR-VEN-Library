...
namespace power
{
  class PowerItemType: public ::oadr2b::emix::ItemBaseType
  {
    ...
    void
    itemDescription (::std::auto_ptr< itemDescription_type > p);
    ...
    void
    itemUnits (::std::auto_ptr< itemUnits_type > p);
    ...
    void
    siScaleCode (::std::auto_ptr< siScaleCode_type > p);
    ...
    void
    powerAttributes (::std::auto_ptr< powerAttributes_type > p);
    ...
    PowerItemType (const itemDescription_type&,
                   const itemUnits_type&,
                   const siScaleCode_type&,
                   ::std::auto_ptr< powerAttributes_type >);

    PowerItemType (::std::auto_ptr< itemDescription_type >,
                   ::std::auto_ptr< itemUnits_type >,
                   ::std::auto_ptr< siScaleCode_type >,
                   ::std::auto_ptr< powerAttributes_type >);
