...
#ifndef SUMMARY_MEASUREMENT_HXX
#define SUMMARY_MEASUREMENT_HXX
...
namespace espi
{
  class SummaryMeasurement: public ::espi::Object
  {
    public:
    ...
    // timeStamp
    //
    typedef ::espi::TimeType timeStamp_type;
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const SummaryMeasurement&);
}
...
{
  void
  operator<< (::xercesc::DOMElement&, const SummaryMeasurement&);
}
