...
namespace oadr2b
{
  namespace ei
  {
    ...
    EiResponseType::
    EiResponseType (::std::auto_ptr< responseCode_type > responseCode,
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, EiResponseType >
    _xsd_EiResponseType_type_factory_init (
      "EiResponseType",
      "http://docs.oasis-open.org/ns/energyinterop/201110");
  }
}
  ...
  namespace ei
  {
    ...
    operator<< (::xercesc::DOMElement& e, const EiResponseType& i)
    {
      ...
      //
      {
        ...
        const EiResponseType::responseCode_type& x (i.responseCode ());
        if (typeid (EiResponseType::responseCode_type) == typeid (x))
        {
      ...
      //
      {
        ...
        if (i.responseDescription ())
        {
          ...
          if (typeid (EiResponseType::responseDescription_type) == typeid (x))
          {
            ::xercesc::DOMElement& s (
              ::xsd::cxx::xml::dom::create_element (
                "responseDescription",
      ...
      //
      {
        ...
        const EiResponseType::requestID_type& x (i.requestID ());
        if (typeid (EiResponseType::requestID_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "requestID",
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, EiResponseType >
    _xsd_EiResponseType_type_serializer_init (
      "EiResponseType",
      "http://docs.oasis-open.org/ns/energyinterop/201110");
  }
}
