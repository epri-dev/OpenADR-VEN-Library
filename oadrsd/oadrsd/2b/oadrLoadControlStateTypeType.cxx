...
namespace oadr2b
{
  namespace oadr
  {
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, oadrLoadControlStateTypeType >
    _xsd_oadrLoadControlStateTypeType_type_factory_init (
      "oadrLoadControlStateTypeType",
      "http://openadr.org/oadr-2.0b/2012/07");
  }
}
...
namespace oadr2b
{
  namespace oadr
  {
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, oadrLoadControlStateTypeType >
    _xsd_oadrLoadControlStateTypeType_type_serializer_init (
      "oadrLoadControlStateTypeType",
      "http://openadr.org/oadr-2.0b/2012/07");
  }
}
