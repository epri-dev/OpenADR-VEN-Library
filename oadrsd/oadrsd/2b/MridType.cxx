...
namespace power
{
  ...
  static
  const ::xsd::cxx::tree::type_factory_initializer< 0, char, MridType >
  _xsd_MridType_type_factory_init (
    "MridType",
...
namespace power
{
  ...
  static
  const ::xsd::cxx::tree::type_serializer_initializer< 0, char, MridType >
  _xsd_MridType_type_serializer_init (
    "MridType",
    "http://docs.oasis-open.org/ns/emix/2011/06/power");
}
