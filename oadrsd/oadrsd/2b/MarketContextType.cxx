...
namespace oadr2b
{
  namespace emix
  {
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, MarketContextType >
    _xsd_MarketContextType_type_factory_init (
      "MarketContextType",
...
namespace oadr2b
{
  namespace emix
  {
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, MarketContextType >
    _xsd_MarketContextType_type_serializer_init (
      "MarketContextType",
      "http://docs.oasis-open.org/ns/emix/2011/06");
  }
}
