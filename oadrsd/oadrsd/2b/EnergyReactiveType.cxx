...
{
  ::std::ostream&
  operator<< (::std::ostream& o, const EnergyReactiveType& i)
  {
  ...
  static
  const ::xsd::cxx::tree::std_ostream_initializer< 0, char, EnergyReactiveType >
  _xsd_EnergyReactiveType_std_ostream_init;
}
