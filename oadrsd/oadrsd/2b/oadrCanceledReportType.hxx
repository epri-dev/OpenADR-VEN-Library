...
namespace oadr2b
{
  namespace oadr
  {
    class oadrCanceledReportType: public ::xml_schema::type
    {
      public:
      // eiResponse
      // 
      ...
      void
      oadrPendingReports (::std::auto_ptr< oadrPendingReports_type > p);
      ...
      oadrCanceledReportType (::std::auto_ptr< eiResponse_type >,
                              ::std::auto_ptr< oadrPendingReports_type >);
