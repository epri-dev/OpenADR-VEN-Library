...
namespace oadr2b
{
  namespace oadr
  {
    class oadrSignedObject: public ::xml_schema::type
    {
      ...
      void
      oadrDistributeEvent (::std::auto_ptr< oadrDistributeEvent_type > p);
      ...
      void
      oadrCreatedEvent (::std::auto_ptr< oadrCreatedEvent_type > p);
      ...
      void
      oadrRequestEvent (::std::auto_ptr< oadrRequestEvent_type > p);
      ...
      void
      oadrResponse (::std::auto_ptr< oadrResponse_type > p);
      ...
      void
      oadrCancelOpt (::std::auto_ptr< oadrCancelOpt_type > p);
      ...
      void
      oadrCanceledOpt (::std::auto_ptr< oadrCanceledOpt_type > p);
      ...
      void
      oadrCreateOpt (::std::auto_ptr< oadrCreateOpt_type > p);
      ...
      void
      oadrCreatedOpt (::std::auto_ptr< oadrCreatedOpt_type > p);
      ...
      void
      oadrCancelReport (::std::auto_ptr< oadrCancelReport_type > p);
      ...
      void
      oadrCanceledReport (::std::auto_ptr< oadrCanceledReport_type > p);
      ...
      void
      oadrCreateReport (::std::auto_ptr< oadrCreateReport_type > p);
      ...
      void
      oadrCreatedReport (::std::auto_ptr< oadrCreatedReport_type > p);
      ...
      void
      oadrRegisterReport (::std::auto_ptr< oadrRegisterReport_type > p);
      ...
      void
      oadrRegisteredReport (::std::auto_ptr< oadrRegisteredReport_type > p);
      ...
      void
      oadrUpdateReport (::std::auto_ptr< oadrUpdateReport_type > p);
      ...
      void
      oadrUpdatedReport (::std::auto_ptr< oadrUpdatedReport_type > p);
      ...
      void
      oadrCancelPartyRegistration (::std::auto_ptr< oadrCancelPartyRegistration_type > p);
      ...
      void
      oadrCanceledPartyRegistration (::std::auto_ptr< oadrCanceledPartyRegistration_type > p);
      ...
      void
      oadrCreatePartyRegistration (::std::auto_ptr< oadrCreatePartyRegistration_type > p);
      ...
      void
      oadrCreatedPartyRegistration (::std::auto_ptr< oadrCreatedPartyRegistration_type > p);
      ...
      void
      oadrRequestReregistration (::std::auto_ptr< oadrRequestReregistration_type > p);
      ...
      void
      oadrQueryRegistration (::std::auto_ptr< oadrQueryRegistration_type > p);
      ...
      void
      oadrPoll (::std::auto_ptr< oadrPoll_type > p);
