...
namespace oadr2b
{
  namespace oadr
  {
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, oadrProfileType >
    _xsd_oadrProfileType_type_factory_init (
      "oadrProfileType",
...
namespace oadr2b
{
  namespace oadr
  {
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, oadrProfileType >
    _xsd_oadrProfileType_type_serializer_init (
      "oadrProfileType",
      "http://openadr.org/oadr-2.0b/2012/07");
  }
}
