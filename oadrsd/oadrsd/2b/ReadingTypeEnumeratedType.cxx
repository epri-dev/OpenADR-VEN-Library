...
namespace oadr2b
{
  namespace ei
  {
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, ReadingTypeEnumeratedType >
    _xsd_ReadingTypeEnumeratedType_type_factory_init (
      "ReadingTypeEnumeratedType",
...
namespace oadr2b
{
  namespace ei
  {
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, ReadingTypeEnumeratedType >
    _xsd_ReadingTypeEnumeratedType_type_serializer_init (
      "ReadingTypeEnumeratedType",
      "http://docs.oasis-open.org/ns/energyinterop/201110");
  }
}
