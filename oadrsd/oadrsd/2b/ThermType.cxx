...
namespace oadr2b
{
  namespace oadr
  {
    ...
    ThermType::
    ThermType (::std::auto_ptr< itemDescription_type > itemDescription,
  ...
  namespace oadr
  {
    ...
    operator<< (::xercesc::DOMElement& e, const ThermType& i)
    {
      ...
      //
      {
        ...
        const ThermType::itemDescription_type& x (i.itemDescription ());
        if (typeid (ThermType::itemDescription_type) == typeid (x))
        {
      ...
      //
      {
        ...
        const ThermType::itemUnits_type& x (i.itemUnits ());
        if (typeid (ThermType::itemUnits_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "itemUnits",
      ...
      //
      {
        ...
        const ThermType::siScaleCode_type& x (i.siScaleCode ());
        if (typeid (ThermType::siScaleCode_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "siScaleCode",
