...
namespace oadr2b
{
  namespace ei
  {
    ...
    void EiOptType::
    optReason (::std::auto_ptr< optReason_type > x)
    {
      this->optReason_.set (x);
    }
    ...
    void EiOptType::
    vavailability (::std::auto_ptr< vavailability_type > x)
    {
      this->vavailability_.set (x);
    }
...
namespace oadr2b
{
  namespace ei
  {
    ...
    EiOptType::
    EiOptType (::std::auto_ptr< optID_type > optID,
        ...
        //
        {
          ::std::auto_ptr< ::xsd::cxx::tree::type > tmp (
            ::xsd::cxx::tree::type_factory_map_instance< 0, char > ().create (
              "optReason",
              "http://docs.oasis-open.org/ns/energyinterop/201110",
              &::xsd::cxx::tree::factory_impl< optReason_type >,
              true, true, i, n, f, this));
          ...
          if (tmp.get () != 0)
          {
            ...
            {
              ::std::auto_ptr< optReason_type > r (
                dynamic_cast< optReason_type* > (tmp.get ()));
        ...
        //
        {
          ::std::auto_ptr< ::xsd::cxx::tree::type > tmp (
            ::xsd::cxx::tree::type_factory_map_instance< 0, char > ().create (
              ...
              &::xsd::cxx::tree::factory_impl< vavailability_type >,
              true, true, i, n, f, this));
          ...
          if (tmp.get () != 0)
          {
            ...
            {
              ::std::auto_ptr< vavailability_type > r (
                dynamic_cast< vavailability_type* > (tmp.get ()));
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, EiOptType >
    _xsd_EiOptType_type_factory_init (
      "EiOptType",
      "http://docs.oasis-open.org/ns/energyinterop/201110");
  }
}
  ...
  namespace ei
  {
    ...
    operator<< (::xercesc::DOMElement& e, const EiOptType& i)
    {
      ...
      //
      {
        ...
        const EiOptType::optID_type& x (i.optID ());
        if (typeid (EiOptType::optID_type) == typeid (x))
        {
      ...
      //
      {
        ...
        const EiOptType::optType_type& x (i.optType ());
        if (typeid (EiOptType::optType_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "optType",
      ...
      //
      {
        ...
        const EiOptType::optReason_type& x (i.optReason ());
        if (typeid (EiOptType::optReason_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "optReason",
      ...
      //
      {
        ...
        if (i.marketContext ())
        {
          const EiOptType::marketContext_type& x (*i.marketContext ());
          if (typeid (EiOptType::marketContext_type) == typeid (x))
          {
            ::xercesc::DOMElement& s (
              ::xsd::cxx::xml::dom::create_element (
                "marketContext",
      ...
      //
      {
        ...
        const EiOptType::venID_type& x (i.venID ());
        if (typeid (EiOptType::venID_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "venID",
      ...
      //
      {
        ...
        if (i.vavailability ())
        {
          const EiOptType::vavailability_type& x (*i.vavailability ());
          if (typeid (EiOptType::vavailability_type) == typeid (x))
          {
            ::xercesc::DOMElement& s (
              ::xsd::cxx::xml::dom::create_element (
                "vavailability",
      ...
      //
      {
        ...
        const EiOptType::createdDateTime_type& x (i.createdDateTime ());
        if (typeid (EiOptType::createdDateTime_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "createdDateTime",
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, EiOptType >
    _xsd_EiOptType_type_serializer_init (
      "EiOptType",
      "http://docs.oasis-open.org/ns/energyinterop/201110");
  }
}
