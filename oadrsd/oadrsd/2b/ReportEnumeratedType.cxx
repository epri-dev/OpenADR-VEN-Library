...
namespace oadr2b
{
  namespace ei
  {
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, ReportEnumeratedType >
    _xsd_ReportEnumeratedType_type_factory_init (
      "ReportEnumeratedType",
...
namespace oadr2b
{
  namespace ei
  {
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, ReportEnumeratedType >
    _xsd_ReportEnumeratedType_type_serializer_init (
      "ReportEnumeratedType",
      "http://docs.oasis-open.org/ns/energyinterop/201110");
  }
}
