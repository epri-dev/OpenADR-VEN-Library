...
namespace oadr2b
{
  namespace sig
  {
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, CanonicalizationMethodType >
...
namespace oadr2b
{
  namespace sig
  {
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, CanonicalizationMethodType >
