...
namespace oadr2b
{
  namespace ei
  {
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, EiExtensionTokenType >
    _xsd_EiExtensionTokenType_type_factory_init (
      "EiExtensionTokenType",
...
namespace oadr2b
{
  namespace ei
  {
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, EiExtensionTokenType >
    _xsd_EiExtensionTokenType_type_serializer_init (
      "EiExtensionTokenType",
      "http://docs.oasis-open.org/ns/energyinterop/201110");
  }
}
