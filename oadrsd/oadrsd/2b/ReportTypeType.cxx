...
namespace oadr2b
{
  namespace ei
  {
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, ReportTypeType >
    _xsd_ReportTypeType_type_factory_init (
      "ReportTypeType",
...
namespace oadr2b
{
  namespace ei
  {
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, ReportTypeType >
    _xsd_ReportTypeType_type_serializer_init (
      "ReportTypeType",
      "http://docs.oasis-open.org/ns/energyinterop/201110");
  }
}
