...
namespace icalendar_2_0
{
  ...
  AvailableType::
  AvailableType (::std::auto_ptr< properties_type > properties)
  : ::xml_schema::type (),
    properties_ (properties, this)
  {
  }
  ...
  static
  const ::xsd::cxx::tree::type_factory_initializer< 0, char, AvailableType >
  _xsd_AvailableType_type_factory_init (
    "AvailableType",
    "urn:ietf:params:xml:ns:icalendar-2.0");
}
...
namespace icalendar_2_0
{
  ...
  static
  const ::xsd::cxx::tree::type_serializer_initializer< 0, char, AvailableType >
  _xsd_AvailableType_type_serializer_init (
    "AvailableType",
    "urn:ietf:params:xml:ns:icalendar-2.0");
}
