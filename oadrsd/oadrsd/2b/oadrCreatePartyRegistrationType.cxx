...
namespace oadr2b
{
  namespace oadr
  {
    ...
    void oadrCreatePartyRegistrationType::
    oadrTransportName (::std::auto_ptr< oadrTransportName_type > x)
    {
      this->oadrTransportName_.set (x);
    }
    ...
    void oadrCreatePartyRegistrationType::
    oadrTransportAddress (::std::auto_ptr< oadrTransportAddress_type > x)
    {
      this->oadrTransportAddress_.set (x);
    }
    ...
    void oadrCreatePartyRegistrationType::
    oadrVenName (::std::auto_ptr< oadrVenName_type > x)
    {
      this->oadrVenName_.set (x);
    }
...
namespace oadr2b
{
  namespace oadr
  {
    ...
    oadrCreatePartyRegistrationType::
    oadrCreatePartyRegistrationType (::std::auto_ptr< requestID_type > requestID,
                                     ::std::auto_ptr< oadrProfileName_type > oadrProfileName,
                                     ::std::auto_ptr< oadrTransportName_type > oadrTransportName,
                                     const oadrReportOnly_type& oadrReportOnly,
                                     const oadrXmlSignature_type& oadrXmlSignature)
    : ::xml_schema::type (),
      requestID_ (requestID, this),
        ...
        //
        {
          ::std::auto_ptr< ::xsd::cxx::tree::type > tmp (
            ::xsd::cxx::tree::type_factory_map_instance< 0, char > ().create (
              "oadrTransportName",
              "http://openadr.org/oadr-2.0b/2012/07",
              &::xsd::cxx::tree::factory_impl< oadrTransportName_type >,
              true, true, i, n, f, this));
          ...
          if (tmp.get () != 0)
          {
            ...
            {
              ::std::auto_ptr< oadrTransportName_type > r (
                dynamic_cast< oadrTransportName_type* > (tmp.get ()));
        ...
        //
        {
          ::std::auto_ptr< ::xsd::cxx::tree::type > tmp (
            ::xsd::cxx::tree::type_factory_map_instance< 0, char > ().create (
              "oadrTransportAddress",
              "http://openadr.org/oadr-2.0b/2012/07",
              &::xsd::cxx::tree::factory_impl< oadrTransportAddress_type >,
              true, true, i, n, f, this));
          ...
          if (tmp.get () != 0)
          {
            ...
            {
              ::std::auto_ptr< oadrTransportAddress_type > r (
                dynamic_cast< oadrTransportAddress_type* > (tmp.get ()));
              ...
              this->oadrTransportAddress_.set (r);
              continue;
            }
          }
        }
        ...
        //
        {
          ::std::auto_ptr< ::xsd::cxx::tree::type > tmp (
            ::xsd::cxx::tree::type_factory_map_instance< 0, char > ().create (
              "oadrVenName",
              "http://openadr.org/oadr-2.0b/2012/07",
              &::xsd::cxx::tree::factory_impl< oadrVenName_type >,
              true, true, i, n, f, this));
          ...
          if (tmp.get () != 0)
          {
            ...
            {
              ::std::auto_ptr< oadrVenName_type > r (
                dynamic_cast< oadrVenName_type* > (tmp.get ()));
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, oadrCreatePartyRegistrationType >
    _xsd_oadrCreatePartyRegistrationType_type_factory_init (
      "oadrCreatePartyRegistrationType",
      "http://openadr.org/oadr-2.0b/2012/07");
  }
}
  ...
  namespace oadr
  {
    ...
    operator<< (::xercesc::DOMElement& e, const oadrCreatePartyRegistrationType& i)
    {
      ...
      //
      {
        ...
        const oadrCreatePartyRegistrationType::requestID_type& x (i.requestID ());
        if (typeid (oadrCreatePartyRegistrationType::requestID_type) == typeid (x))
        {
      ...
      //
      {
        ...
        if (i.venID ())
        {
          const oadrCreatePartyRegistrationType::venID_type& x (*i.venID ());
          if (typeid (oadrCreatePartyRegistrationType::venID_type) == typeid (x))
          {
            ::xercesc::DOMElement& s (
              ::xsd::cxx::xml::dom::create_element (
                "venID",
      ...
      //
      {
        ...
        const oadrCreatePartyRegistrationType::oadrProfileName_type& x (i.oadrProfileName ());
        if (typeid (oadrCreatePartyRegistrationType::oadrProfileName_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "oadrProfileName",
      ...
      //
      {
        ...
        const oadrCreatePartyRegistrationType::oadrTransportName_type& x (i.oadrTransportName ());
        if (typeid (oadrCreatePartyRegistrationType::oadrTransportName_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "oadrTransportName",
      ...
      //
      {
        ...
        {
          const oadrCreatePartyRegistrationType::oadrTransportAddress_type& x (*i.oadrTransportAddress ());
          if (typeid (oadrCreatePartyRegistrationType::oadrTransportAddress_type) == typeid (x))
          {
            ::xercesc::DOMElement& s (
              ::xsd::cxx::xml::dom::create_element (
                "oadrTransportAddress",
      ...
      //
      {
        ...
        if (i.oadrVenName ())
        {
          const oadrCreatePartyRegistrationType::oadrVenName_type& x (*i.oadrVenName ());
          if (typeid (oadrCreatePartyRegistrationType::oadrVenName_type) == typeid (x))
          {
            ::xercesc::DOMElement& s (
              ::xsd::cxx::xml::dom::create_element (
                "oadrVenName",
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, oadrCreatePartyRegistrationType >
    _xsd_oadrCreatePartyRegistrationType_type_serializer_init (
      "oadrCreatePartyRegistrationType",
      "http://openadr.org/oadr-2.0b/2012/07");
  }
}
