...
namespace oadr2b
{
  namespace oadr
  {
    ...
    BaseUnitType::
    BaseUnitType (::std::auto_ptr< itemDescription_type > itemDescription,
  ...
  namespace oadr
  {
    ...
    operator<< (::xercesc::DOMElement& e, const BaseUnitType& i)
    {
      ...
      //
      {
        ...
        const BaseUnitType::itemDescription_type& x (i.itemDescription ());
        if (typeid (BaseUnitType::itemDescription_type) == typeid (x))
        {
      ...
      //
      {
        ...
        const BaseUnitType::itemUnits_type& x (i.itemUnits ());
        if (typeid (BaseUnitType::itemUnits_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "itemUnits",
      ...
      //
      {
        ...
        const BaseUnitType::siScaleCode_type& x (i.siScaleCode ());
        if (typeid (BaseUnitType::siScaleCode_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "siScaleCode",
