...
namespace icalendar_2_0
{
  ...
  VavailabilityType::
  VavailabilityType (::std::auto_ptr< components_type > components)
  : ::xml_schema::type (),
    components_ (components, this)
  {
  }
  ...
  static
  const ::xsd::cxx::tree::type_factory_initializer< 0, char, VavailabilityType >
  _xsd_VavailabilityType_type_factory_init (
    "VavailabilityType",
    "urn:ietf:params:xml:ns:icalendar-2.0");
}
...
namespace icalendar_2_0
{
  ...
  operator<< (::xercesc::DOMElement& e, const VavailabilityType& i)
  {
    ...
    //
    {
      ...
      const VavailabilityType::components_type& x (i.components ());
      if (typeid (VavailabilityType::components_type) == typeid (x))
      {
  ...
  static
  const ::xsd::cxx::tree::type_serializer_initializer< 0, char, VavailabilityType >
  _xsd_VavailabilityType_type_serializer_init (
    "VavailabilityType",
    "urn:ietf:params:xml:ns:icalendar-2.0");
}
