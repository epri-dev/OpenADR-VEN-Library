...
namespace oadr2b
{
  namespace ei
  {
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, ArrayofResponses >
    _xsd_ArrayofResponses_type_factory_init (
      "ArrayofResponses",
      "http://docs.oasis-open.org/ns/energyinterop/201110");
  }
}
...
namespace oadr2b
{
  namespace ei
  {
    ...
    operator<< (::xercesc::DOMElement& e, const ArrayofResponses& i)
    {
      ...
      //
      {
        ...
        for (ArrayofResponses::response_const_iterator
             ...
             b != n; ++b)
        {
          if (typeid (ArrayofResponses::response_type) == typeid (*b))
          {
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, ArrayofResponses >
    _xsd_ArrayofResponses_type_serializer_init (
      "ArrayofResponses",
      "http://docs.oasis-open.org/ns/energyinterop/201110");
  }
}
