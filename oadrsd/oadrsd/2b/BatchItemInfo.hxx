...
#ifndef BATCH_ITEM_INFO_HXX
#define BATCH_ITEM_INFO_HXX
...
namespace espi
{
  class BatchItemInfo: public ::espi::Object
  {
    public:
    // name
    //
    typedef ::espi::HexBinary16 name_type;
    ...
    // operation
    //
    typedef ::espi::CRUDOperation operation_type;
    ...
    // statusCode
    //
    typedef ::espi::StatusCode statusCode_type;
    typedef ::xsd::cxx::tree::optional< statusCode_type > statusCode_optional;
    typedef ::xsd::cxx::tree::traits< statusCode_type, char > statusCode_traits;
    ...
    // statusReason
    //
    typedef ::espi::String256 statusReason_type;
    typedef ::xsd::cxx::tree::optional< statusReason_type > statusReason_optional;
    typedef ::xsd::cxx::tree::traits< statusReason_type, char > statusReason_traits;

    const statusReason_optional&
    statusReason () const;
    ...
    void
    statusReason (::std::unique_ptr< statusReason_type > p);
    ...
    statusReason_optional statusReason_;
  };
}
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const BatchItemInfo&);
}
...
{
  void
  operator<< (::xercesc::DOMElement&, const BatchItemInfo&);
}
