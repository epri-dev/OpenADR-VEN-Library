...
namespace oadr2b
{
  namespace gml
  {
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, doubleList >
    _xsd_doubleList_type_factory_init (
      "doubleList",
...
namespace oadr2b
{
  namespace gml
  {
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, doubleList >
    _xsd_doubleList_type_serializer_init (
      "doubleList",
      "http://www.opengis.net/gml/3.2");
  }
}
