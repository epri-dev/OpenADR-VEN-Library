...
namespace power
{
  ...
  EndDeviceAssetType::
  EndDeviceAssetType (::std::auto_ptr< mrid_type > mrid)
  : ::xml_schema::type (),
    mrid_ (mrid, this)
  {
  }
      ...
      //
      {
        ::std::auto_ptr< ::xsd::cxx::tree::type > tmp (
          ::xsd::cxx::tree::type_factory_map_instance< 0, char > ().create (
            ...
            &::xsd::cxx::tree::factory_impl< mrid_type >,
        ...
        if (tmp.get () != 0)
        {
          if (!mrid_.present ())
          {
            ::std::auto_ptr< mrid_type > r (
              dynamic_cast< mrid_type* > (tmp.get ()));
  ...
  static
  const ::xsd::cxx::tree::type_factory_initializer< 0, char, EndDeviceAssetType >
  _xsd_EndDeviceAssetType_type_factory_init (
    "EndDeviceAssetType",
    "http://docs.oasis-open.org/ns/emix/2011/06/power");
}
...
namespace power
{
  ...
  operator<< (::xercesc::DOMElement& e, const EndDeviceAssetType& i)
  {
    ...
    //
    {
      ...
      const EndDeviceAssetType::mrid_type& x (i.mrid ());
      if (typeid (EndDeviceAssetType::mrid_type) == typeid (x))
      {
  ...
  static
  const ::xsd::cxx::tree::type_serializer_initializer< 0, char, EndDeviceAssetType >
  _xsd_EndDeviceAssetType_type_serializer_init (
    "EndDeviceAssetType",
    "http://docs.oasis-open.org/ns/emix/2011/06/power");
}
