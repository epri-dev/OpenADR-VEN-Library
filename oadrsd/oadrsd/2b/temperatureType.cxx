...
namespace oadr2b
{
  namespace oadr
  {
    ...
    temperatureType::
    temperatureType (::std::auto_ptr< itemDescription_type > itemDescription,
  ...
  namespace oadr
  {
    ...
    operator<< (::xercesc::DOMElement& e, const temperatureType& i)
    {
      ...
      //
      {
        ...
        const temperatureType::itemDescription_type& x (i.itemDescription ());
        if (typeid (temperatureType::itemDescription_type) == typeid (x))
        {
      ...
      //
      {
        ...
        const temperatureType::itemUnits_type& x (i.itemUnits ());
        if (typeid (temperatureType::itemUnits_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "itemUnits",
      ...
      //
      {
        ...
        const temperatureType::siScaleCode_type& x (i.siScaleCode ());
        if (typeid (temperatureType::siScaleCode_type) == typeid (x))
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
              "siScaleCode",
