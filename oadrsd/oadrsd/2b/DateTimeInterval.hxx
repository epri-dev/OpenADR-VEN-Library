...
#ifndef DATE_TIME_INTERVAL_HXX
#define DATE_TIME_INTERVAL_HXX
...
namespace espi
{
  class DateTimeInterval: public ::espi::Object
  {
    public:
    // duration
    //
    typedef ::espi::UInt32 duration_type;
    ...
    // start
    //
    typedef ::espi::TimeType start_type;
...
{
  ::std::ostream&
  operator<< (::std::ostream&, const DateTimeInterval&);
}
...
{
  void
  operator<< (::xercesc::DOMElement&, const DateTimeInterval&);
}
