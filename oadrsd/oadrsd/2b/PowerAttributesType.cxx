...
namespace power
{
  ...
  static
  const ::xsd::cxx::tree::type_factory_initializer< 0, char, PowerAttributesType >
  _xsd_PowerAttributesType_type_factory_init (
    "PowerAttributesType",
    "http://docs.oasis-open.org/ns/emix/2011/06/power");
}
...
namespace power
{
  ...
  static
  const ::xsd::cxx::tree::type_serializer_initializer< 0, char, PowerAttributesType >
  _xsd_PowerAttributesType_type_serializer_init (
    "PowerAttributesType",
    "http://docs.oasis-open.org/ns/emix/2011/06/power");
}
