...
namespace icalendar_2_0
{
  ...
  static
  const ::xsd::cxx::tree::type_factory_initializer< 0, char, DurationValueType >
...
namespace icalendar_2_0
{
  ...
  static
  const ::xsd::cxx::tree::type_serializer_initializer< 0, char, DurationValueType >
  _xsd_DurationValueType_type_serializer_init (
    "DurationValueType",
    "urn:ietf:params:xml:ns:icalendar-2.0");
}
