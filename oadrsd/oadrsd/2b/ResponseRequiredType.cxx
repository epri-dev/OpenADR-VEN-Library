...
namespace oadr2b
{
  namespace oadr
  {
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, ResponseRequiredType >
    _xsd_ResponseRequiredType_type_factory_init (
      "ResponseRequiredType",
...
namespace oadr2b
{
  namespace oadr
  {
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, ResponseRequiredType >
    _xsd_ResponseRequiredType_type_serializer_init (
      "ResponseRequiredType",
      "http://openadr.org/oadr-2.0b/2012/07");
  }
}
