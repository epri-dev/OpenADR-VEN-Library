...
#ifndef LINE_ITEM_HXX
#define LINE_ITEM_HXX
...
namespace espi
{
  class LineItem: public ::xml_schema::type
  {
    public:
    // amount
    // 
    typedef ::espi::Int48 amount_type;
    ...
    // rounding
    // 
    typedef ::espi::Int48 rounding_type;
    typedef ::xsd::cxx::tree::optional< rounding_type > rounding_optional;
    typedef ::xsd::cxx::tree::traits< rounding_type, char > rounding_traits;

    const rounding_optional&
    rounding () const;
    ...
    void
    rounding (::std::auto_ptr< rounding_type > p);

    // dateTime
    // 
    typedef ::espi::TimeType dateTime_type;
    ...
    // note
    // 
    typedef ::espi::String256 note_type;
    ...
    // Constructors.
    //
    LineItem (const amount_type&,
              const dateTime_type&,
              const note_type&);

    LineItem (::std::auto_ptr< amount_type >,
              ::std::auto_ptr< dateTime_type >,
...
{
  void
  operator<< (::xercesc::DOMElement&, const LineItem&);
}
