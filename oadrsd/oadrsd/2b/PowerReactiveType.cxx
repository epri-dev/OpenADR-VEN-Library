...
{
  ::std::ostream&
  operator<< (::std::ostream& o, const PowerReactiveType& i)
  {
  ...
  static
  const ::xsd::cxx::tree::std_ostream_initializer< 0, char, PowerReactiveType >
  _xsd_PowerReactiveType_std_ostream_init;
}
