...
namespace oadr2b
{
  namespace ei
  {
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, ConfidenceType >
    _xsd_ConfidenceType_type_factory_init (
      "ConfidenceType",
...
namespace oadr2b
{
  namespace ei
  {
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, ConfidenceType >
    _xsd_ConfidenceType_type_serializer_init (
      "ConfidenceType",
      "http://docs.oasis-open.org/ns/energyinterop/201110");
  }
}
