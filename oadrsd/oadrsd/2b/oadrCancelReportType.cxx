...
namespace oadr2b
{
  namespace oadr
  {
    ...
    oadrCancelReportType::
    oadrCancelReportType (::std::auto_ptr< requestID_type > requestID,
                          const reportToFollow_type& reportToFollow)
    : ::xml_schema::type (),
      requestID_ (requestID, this),
      reportRequestID_ (this),
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, oadrCancelReportType >
    _xsd_oadrCancelReportType_type_factory_init (
      "oadrCancelReportType",
  ...
  namespace oadr
  {
    ...
    operator<< (::xercesc::DOMElement& e, const oadrCancelReportType& i)
    {
      ...
      //
      {
        ...
        const oadrCancelReportType::requestID_type& x (i.requestID ());
        if (typeid (oadrCancelReportType::requestID_type) == typeid (x))
        {
      ...
      //
      {
        ...
        for (oadrCancelReportType::reportRequestID_const_iterator
             ...
             b != n; ++b)
        {
          if (typeid (oadrCancelReportType::reportRequestID_type) == typeid (*b))
          {
            ::xercesc::DOMElement& s (
              ::xsd::cxx::xml::dom::create_element (
                "reportRequestID",
      ...
      //
      {
        ...
        if (i.venID ())
        {
          const oadrCancelReportType::venID_type& x (*i.venID ());
          if (typeid (oadrCancelReportType::venID_type) == typeid (x))
          {
            ::xercesc::DOMElement& s (
              ::xsd::cxx::xml::dom::create_element (
                "venID",
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, oadrCancelReportType >
    _xsd_oadrCancelReportType_type_serializer_init (
      "oadrCancelReportType",
      "http://openadr.org/oadr-2.0b/2012/07");
  }
}
