...
namespace oadr2b
{
  namespace oadr
  {
    class oadrProfile: public ::xml_schema::type
    {
      public:
      // oadrProfileName
      // 
      ...
      void
      oadrTransports (::std::auto_ptr< oadrTransports_type > p);
      ...
      oadrProfile (const oadrProfileName_type&,
                   ::std::auto_ptr< oadrTransports_type >);

      oadrProfile (::std::auto_ptr< oadrProfileName_type >,
                   ::std::auto_ptr< oadrTransports_type >);
