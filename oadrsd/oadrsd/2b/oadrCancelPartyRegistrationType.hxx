...
namespace oadr2b
{
  namespace oadr
  {
    class oadrCancelPartyRegistrationType: public ::xml_schema::type
    {
      public:
      // requestID
      // 
      ...
      oadrCancelPartyRegistrationType (::std::auto_ptr< requestID_type >,
                                       ::std::auto_ptr< registrationID_type >);
