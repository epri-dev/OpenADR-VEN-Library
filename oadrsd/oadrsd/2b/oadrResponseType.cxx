...
namespace oadr2b
{
  namespace oadr
  {
    ...
    oadrResponseType::
    oadrResponseType (::std::auto_ptr< eiResponse_type > eiResponse)
    : ::xml_schema::type (),
      eiResponse_ (eiResponse, this),
      venID_ (this),
      schemaVersion_ (this)
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, oadrResponseType >
    _xsd_oadrResponseType_type_factory_init (
      "oadrResponseType",
  ...
  namespace oadr
  {
    ...
    operator<< (::xercesc::DOMElement& e, const oadrResponseType& i)
    {
      ...
      //
      {
        ...
        const oadrResponseType::eiResponse_type& x (i.eiResponse ());
        if (typeid (oadrResponseType::eiResponse_type) == typeid (x))
        {
      ...
      //
      {
        ...
        if (i.venID ())
        {
          const oadrResponseType::venID_type& x (*i.venID ());
          if (typeid (oadrResponseType::venID_type) == typeid (x))
          {
            ::xercesc::DOMElement& s (
              ::xsd::cxx::xml::dom::create_element (
                "venID",
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, oadrResponseType >
    _xsd_oadrResponseType_type_serializer_init (
      "oadrResponseType",
      "http://openadr.org/oadr-2.0b/2012/07");
  }
}
